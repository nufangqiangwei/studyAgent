...
import (
	...
	"agent/internal/llm"
	"agent/internal/llm/anthropic"
	"agent/internal/llm/deepseek"
	"agent/internal/llm/gemini"
	"agent/internal/llm/mock"
	"agent/internal/llm/openai"
)
...
type requestBuilder interface {
	Build(req llm.Request) ([]byte, error)
}

type responseParser interface {
	Parse(req llm.Request, body []byte) (llm.Response, error)
}
...
func New(opts Options) (llm.Client, error) {
...
func newDeepSeekClient(opts Options) llm.Client {
