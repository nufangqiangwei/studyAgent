...
func (p openAIParser) Parse(req llm.Request, body []byte) (llm.Response, error) {
	var parsed openAIChatResponse
	if err := json.Unmarshal(body, &parsed); err != nil {
		return llm.Response{}, err
	}
	if parsed.Error != nil {
		return llm.Response{}, parsed.Error
	}
	if len(parsed.Choices) == 0 {
		return llm.Response{}, fmt.Errorf("response has no choices")
	}
...
func (p anthropicParser) Parse(req llm.Request, body []byte) (llm.Response, error) {
...
func (geminiParser) Parse(req llm.Request, body []byte) (llm.Response, error) {
	...
	if len(parsed.Candidates) == 0 {
		return llm.Response{}, fmt.Errorf("response has no candidates")
	}
